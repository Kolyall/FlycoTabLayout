...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        if (ta.hasValue(R.styleable.CommonTabLayout_tl_textTypeface)) {
            mTypeface = Typeface.createFromAsset(getContext().getAssets(), ta.getString(R.styleable.CommonTabLayout_tl_textTypeface));
        }
    ...
    public void setTabData(String[] titles) {
        ...
        ArrayList<CustomTabEntity> tabEntitys = new ArrayList<>(titles.length);
        for (String title : titles) {
            tabEntitys.add(new TabEntity(title));
        }
